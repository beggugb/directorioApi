...
class ClienteService {
  ...
  static data(page,num,categoria) {
    return new Promise((resolve, reject) => {     
      ...
      Cliente.findAndCountAll({
        ...
        attributes: ["id","likes","views","nombres","filename","direccion","telefono","descripcion","paqueteId","celular","categoriaId"],        
        include: [{ 
          model: Horario,           
  ...
  static item(clienteId) {
    return new Promise((resolve, reject) => {
      ...
      Cliente.findByPk(clienteId,{        
        attributes: ["id","nombres","direccion",
        "telefono",
        "celular",
        "email",
        "web",
  ...
  static search(page, num, nombres) {
	...
	order: [["nombres", "ASC"]],      
        ...
        attributes: ["id","celular","nombres","direccion","email","coordenadas","habilitado","telefono","descripcion","filename"]
      })
        .then((clientes) =>
          resolve({
            paginas: Math.ceil(clientes.count / num),
